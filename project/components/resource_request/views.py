...
async def get_resource_request(resource_request_id: str):
    return JSONResponse(content={'message': 'Not Implemented'}, status_code=501)
...
async def update_resource_request(resource_request_id: str):
    return JSONResponse(content={'message': 'Not Implemented'}, status_code=501)


@router.delete('/{resource_request_id}', summary='Delete a resource_request.')
async def delete_resource_request(resource_request_id: str):
    return JSONResponse(content={'message': 'Not Implemented'}, status_code=501)
